...
O âmbito deste projeto centrou-se na criação de um modelo de apoio à decisão (MAD), desenvolvido em python, com o objetivo de automatizar os processos de obtenção de cotações a fornecer a clientes no área dos transportes terrestres nacionais da empresa X.
